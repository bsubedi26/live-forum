...
class ThreadPagination extends React.Component {
  ...
  setActive(active, e) {
    ...
    dispatch({ type: 'UI_SET_THREADS_ACTIVE', payload: { topic, active } });
  }
  ...
  handlePrevious = (e) => {
    ...
    dispatch({ type: 'UI_SET_THREADS_PREVIOUS', payload: { topic } });
  }
 ...
 handleNext = (e) => {
    ...
    dispatch({ type: 'UI_SET_THREADS_NEXT', payload: { topic } });
  }
