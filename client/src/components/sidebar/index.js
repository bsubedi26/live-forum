...
import SidebarContent from './Container'
...
class SidebarFixed extends Component {
  ...
  onTouchEnd () {
    if (this.isTouching()) {
      ...
      const opt1 = this.props.open && touchWidth < this.state.sidebarWidth - this.props.dragToggleDistance
      const opt2 = !this.props.open && touchWidth > this.props.dragToggleDistance
